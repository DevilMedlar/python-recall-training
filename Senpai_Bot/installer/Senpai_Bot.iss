...
SetupMutex=DevilMedlar.Senpai_Bot.Setup
SetupLogging=yes
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Launch {#MyAppName}"; Flags: nowait postinstall skipifsilent runasoriginaluser unchecked
